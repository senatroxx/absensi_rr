<?php
    ...
    $nip = $_GET['nip'];
    $data = mysqli_query($koneksi, "SELECT * FROM tbl_karyawan WHERE nip='$nip'");
                    ...
                    <form action="updateKaryawan.php" method="post">
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input class="form-control" value="<?= $fetch['nip'] ?>" type="number" name="nip" id="" onkeydown="return false">
                            </div>
                            <div class="form-group">
                                <label for="nama">Nama</label>
                                <input class="form-control" value="<?= $fetch['nama'] ?>" type="text" name="nama" id="">
                            </div>
                            <div class="form-group">
                                <label for="lahir">Tanggal Lahir</label>
                                <input class="form-control" value="<?= $fetch['tanggal_lahir'] ?>" type="date" name="lahir" id="">
                            </div>
                            <div class="form-group">
                                <label for="hp">No Hp</label>
                                <input class="form-control" value="<?= $fetch['nohp'] ?>" type="number" name="hp" id="">
                            </div>  
                        </div>
                        <div class="col-lg-6">
                            <div class="form-group">
                                <label for="alamat">Alamat</label>
                                <textarea class="form-control" name="alamat" id=""><?= $fetch['alamat'] ?></textarea>
                            </div>
                            <div class="form-group">
                                <label for="password">Password</label>
                                <input class="form-control" type="password" name="password" id="" value="<?= $fetch['password'] ?>">
                            </div>
